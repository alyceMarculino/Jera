				...
				<main>
					...
					<br>
						...
						<?php
							...
							$declaracao = $conexao->prepare("SELECT id_filme FROM javistos WHERE codigo_perfil=?");
							...
							?>
								<div class="alert alert-primary" role="alert" align="center">
									<h3> Você ainda não viu nenhum filme de sua lista.</h3><br>
									<a href="minhaLista.php"> <b> Ver minha lista  Agora <b> </a>
								</div>	
							<?php
							} 
							else {
